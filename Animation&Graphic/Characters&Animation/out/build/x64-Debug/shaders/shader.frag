...
uniform vec3 AmbientColor1 = vec3(0.2);
uniform vec3 LightDirection1 = normalize(vec3(5, 5, 5));
uniform vec3 LightColor1 = vec3(5,0.1,0.1);
...
void main()
{
	...
	//adding second light
	irradiance += AmbientColor1 + LightColor1 * max(0, dot(LightDirection1, fragNormal));
